...
import { StyleSheet, StatusBar ,View, Text, TextInput, TouchableWithoutFeedback, Image, ScrollView} from "react-native";
    ...
    <View style = {{backgroundColor: '#F1F1F1',}}>
      ...
      <View style = {style.header}>
        ...
        <View style = {[{flex: 1, borderRadius: 90},style.fullAlign]}>
          <Image style = {style.userAvatar} source={
      ...
      <View style = {style.footer}>
        <View style = {{flex: 6, justifyContent: "center"}}>
          <TextInput style = {style.baseText} multiline placeholder="Type type" placeholderTextColor = {"#747474"}></TextInput>
        </View>
