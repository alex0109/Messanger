...
import ChatRequest from "@/pages/ChatList/components/ChatRequest";
...
const InitialStackNavigator = () => {
  ...
  return (
    <InitialStack.Navigator
      ...
      />
      <InitialStack.Screen name='ChatRequestStack' component={ChatRequestStack} />
      <InitialStack.Screen
        name='DialogStack'
